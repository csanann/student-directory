...
#-------------------------------------------------
def save_students
    file = File.open("data/students.csv", "w")
...
#-------------------------------------------------
def load_students
    file = File.open("data/students.csv", "r")
    file.readlines.each do |line|
        name, cohort, student_number, email_address, phone_number, hobbies = line.chomp.split(',')
        @students << {name: name, cohort: cohort.to_sym, student_number: student_number.to_i, email_address: email_address, phone_number: phone_number.to_i, hobbies: hobbies }
    end
    file.close
end
#--------------------------------------------------
