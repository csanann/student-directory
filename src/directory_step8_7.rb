#ask the user for both name and the cohort, if one of the values is empty, supply a default value
#and convert it to a symbol and prevent the error
...
def input_students
    ...
    while !name.empty? do
        ...
        puts "Now we have #{students.count}#{student.count == 1 ? 'student': 'student'}"
